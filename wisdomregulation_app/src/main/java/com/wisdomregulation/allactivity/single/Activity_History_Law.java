...
import com.wisdomregulation.adapter.Adapter_HistoryBlock_Law;
...
public class Activity_History_Law extends Base_AyActivity{
	...
	public void initData() {
		...
		searchtarget=new Entity_Law().init().put(10, id).setCreated(Static_InfoApp.create().getAccountId());
		baselist=new ArrayList<Base_Entity>();
		adapter=new Adapter_HistoryBlock_Law(this, baselist);
	...
	public void initView(){
		Activity_History_Law.this.showWait();
		setLimt();
		new Handler().postDelayed(new Runnable() {
			public void run() {
				...
				Activity_History_Law.this.dissmissWait();
			}
		}, 300);
	}
