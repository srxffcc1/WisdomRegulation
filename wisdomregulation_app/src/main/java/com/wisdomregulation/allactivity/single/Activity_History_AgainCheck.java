...
import com.wisdomregulation.adapter.Adapter_HistoryBlock_CheckAgain;
...
public class Activity_History_AgainCheck extends Base_AyActivity{
	...
	public void initData() {
		...
		searchtarget=new Entity_Check().init().put(5, id).put(16, "1").setCreated(Static_InfoApp.create().getAccountId());
		baselist=new ArrayList<Base_Entity>();
		adapter=new Adapter_HistoryBlock_CheckAgain(this, baselist);
	...
	public void initView(){
		Activity_History_AgainCheck.this.showWait();
		setLimt();
		new Handler().postDelayed(new Runnable() {
			public void run() {
				...
				Activity_History_AgainCheck.this.dissmissWait();
			}
		}, 300);
	}
