...
import com.wisdomregulation.adapter.Adapter_Model;
...
public class Activity_Model extends Base_AyActivity {
	private ListView companyViewList;
	private Adapter_Model adapter;
	...
	public void initWidget() {
		...
		adapter = new Adapter_Model(
				Activity_Model.this, companyList);
