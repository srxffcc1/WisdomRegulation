...
public class Adapter_LibraryList_5 extends BaseAdapter{
	private Activity context;
	private List<Base_Entity> noticelistdata;
	private String editstate="0";
	public Adapter_LibraryList_5(Activity context, List<Base_Entity> noticelistdata) {
		super();
	...
	public Adapter_LibraryList_5 setEditstate(String editstate) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		convertView=LayoutInflater.from(context).inflate(R.layout.item_activity_library5, null);
