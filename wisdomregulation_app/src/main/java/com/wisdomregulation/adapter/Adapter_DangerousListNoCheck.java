...
public class Adapter_DangerousListNoCheck extends BaseAdapter{
	private Activity context;
	private List<Base_Entity> dangerouslistdata;
	private String editstate="0";
	public Adapter_DangerousListNoCheck(Activity context, List<Base_Entity> lawList) {
		super();
	...
	public Adapter_DangerousListNoCheck setEditstate(String editstate) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		convertView=LayoutInflater.from(context).inflate(R.layout.item_activity_dangerousnocheck, null);
