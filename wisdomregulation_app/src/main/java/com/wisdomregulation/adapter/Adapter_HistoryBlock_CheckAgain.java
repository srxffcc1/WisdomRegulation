...
public class Adapter_HistoryBlock_CheckAgain extends BaseAdapter{
	private Activity context;
	private List<Base_Entity> noticelistdata;
	private String editstate="0";
	public Adapter_HistoryBlock_CheckAgain(Activity context, List<Base_Entity> noticelistdata) {
		super();
	...
	public Adapter_HistoryBlock_CheckAgain setEditstate(String editstate) {
