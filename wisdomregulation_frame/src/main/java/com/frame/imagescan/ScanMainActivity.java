	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case SCAN_OK:
				...
				adapter = new GroupAdapter(ScanMainActivity.this, list = subGroupOfImage(mGruopMap), mGroupGridView);
	...
	private void getImages() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				ContentResolver mContentResolver = ScanMainActivity.this.getContentResolver();
