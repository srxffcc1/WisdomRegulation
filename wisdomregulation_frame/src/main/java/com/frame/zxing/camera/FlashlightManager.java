...
package com.frame.zxing.camera;
...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      com.wisdomregulation.utils.Log.v(TAG, "This device does supports control of a flashlight");
    } else {
      com.wisdomregulation.utils.Log.v(TAG, "This device does not support control of a flashlight");
    }
  }
  ...
  private static Class<?> maybeForName(String name) {
    try {
      ...
      com.wisdomregulation.utils.Log.w(TAG, "Unexpected error while finding class " + name+":"+re);
      return null;
    }
  }
  ...
  private static Method maybeGetMethod(Class<?> clazz, String name, Class<?>... argClasses) {
    try {
      ...
      com.wisdomregulation.utils.Log.w(TAG, "Unexpected error while finding method " + name+":"+re);
      return null;
    }
  }
  ...
  private static Object invoke(Method method, Object instance, Object... args) {
    try {
      ...
      com.wisdomregulation.utils.Log.w(TAG, "Unexpected error while invoking " + method+":"+e);
      return null;
    } catch (InvocationTargetException e) {
      com.wisdomregulation.utils.Log.w(TAG, "Unexpected error while invoking " + method+":"+e.getCause());
      return null;
    } catch (RuntimeException re) {
      com.wisdomregulation.utils.Log.w(TAG, "Unexpected error while invoking " + method+":"+re);
      return null;
    }
  }
