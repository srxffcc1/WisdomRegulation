...
public class GifDecoder extends Thread {
	...
	private void openFile() {
		try {
			...
			com.wisdomregulation.utils.Log.e("open failed", ex.toString());
		}
	}
	...
	public void run() {
		try {
			...
			com.wisdomregulation.utils.Log.e("GifView decode run", ex.toString());
			ex.printStackTrace();
		}
	}
	...
	private void setPixels() {
		try {
			...
			com.wisdomregulation.utils.Log.e("GifView decode setpixel", ex.toString());
		}
	}
