...
public class GifView extends ImageView implements GifAction, GifReDraw {
	...
	private static final int[] mAttr = { android.R.attr.src};
	private Handler redrawHandler = new Handler() {
		public void handleMessage(Message msg) {
			try {
				drawImage();
			} catch (Exception ex) {
				com.wisdomregulation.utils.Log.e("GifView", ex.toString());
			}
		}
	};
	...
	public GifView(Context context, AttributeSet attrs, int defStyle) {
		...
		ta.getValue(R.styleable.GifView_android_src, outValue);
		String file=outValue.string!=null?outValue.string.toString():"";
...
//		Drawable d = a.getDrawable(com.android.internal.R.styleable.ImageView_src);
		...
		if(file.endsWith("gif")){
			isgif = true;
			setGifImage(outValue.resourceId);
			setLoopAnimation();
		}
	}
	...
	{
		//io.vov.vitamio.utils.Log.d("-------------------------",String.valueOf(visibility));
	}
	...
	public void parseReturn(int iResult) {
		...
		switch (iResult) {
		case RETURN_FIRST:
			com.wisdomregulation.utils.Log.d("parseReturn", "FIRST");
			...
			break;
		case RETURN_FINISH:
			com.wisdomregulation.utils.Log.d("parseReturn", "FINISH");
		...
		case RETURN_CACHE_FINISH:
			com.wisdomregulation.utils.Log.d("parseReturn", "CACHE_FINISH");
			if (animationRun == false) {
				reAnimation();
				animationRun = true;
			}
			break;
		case RETURN_ERROR:
			com.wisdomregulation.utils.Log.e("parseReturn", "ERROR");
			break;
		}
	}
