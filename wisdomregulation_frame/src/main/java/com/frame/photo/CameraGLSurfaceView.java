...
public class CameraGLSurfaceView extends GLSurfaceView implements Renderer, SurfaceTexture.OnFrameAvailableListener {
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		com.wisdomregulation.utils.Log.i(TAG, "onSurfaceCreated...");
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
		// TODO Auto-generated method stub
		com.wisdomregulation.utils.Log.i(TAG, "onSurfaceChanged...");
		GLES20.glViewport(0, 0, width, height);
		if(!CameraInterface.getInstance().isPreviewing()){
			float previewRate = DisplayUtil.getScreenRate(mContext); 
			Point P = DisplayUtil.getScreenMetrics(mContext);
			float H = P.y;
			CameraInterface.getInstance().doStartPreview(mSurface, previewRate,(int)H);
		}
	...
	public void onDrawFrame(GL10 gl) {
		// TODO Auto-generated method stub
		com.wisdomregulation.utils.Log.i(TAG, "onDrawFrame...");
	...
	public void onFrameAvailable(SurfaceTexture surfaceTexture) {
		// TODO Auto-generated method stub
		com.wisdomregulation.utils.Log.i(TAG, "onFrameAvailable...");
		this.requestRender();
	}
