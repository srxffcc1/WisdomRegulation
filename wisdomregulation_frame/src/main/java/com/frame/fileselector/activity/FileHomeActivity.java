...
import com.frame.fileselector.util.SDCardScanner;
...
public class FileHomeActivity extends Activity implements OnClickListener {
	...
	public void initLayout() {
		setContentView(R.layout.file_activity_file_home);
	...
	public void onClick(View view) {
		...
		} else if (i == R.id.rl_file_home_sd) {
