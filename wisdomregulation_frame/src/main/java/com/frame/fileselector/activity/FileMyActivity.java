...
import com.frame.fileselector.adapter.FileMyListAdapter;
...
public class FileMyActivity extends Activity implements OnClickListener, OnItemClickListener {
	...
	public void initLayout() {
		setContentView(R.layout.file_activity_file_my);
	...
	public void onClick(View view) {
		int i = view.getId();
		if (i == R.id.iv_file_my_back) {
			onBackPressed();

		} else if (i == R.id.btn_file_my_ok) {
