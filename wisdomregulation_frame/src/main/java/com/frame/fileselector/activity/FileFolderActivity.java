...
import com.frame.fileselector.adapter.FileFolderListAdapter;
import com.frame.fileselector.bean.MyFile;
import com.frame.fileselector.bean.SelectedFiles;
import com.frame.fileselector.util.EmptyFileFilter;
import com.frame.fileselector.util.FileComparator;
...
public class FileFolderActivity extends Activity implements OnClickListener, OnItemClickListener {
	...
	public void initLayout() {
		setContentView(R.layout.file_activity_file_folder);
	...
	public void onClick(View view) {
		int i = view.getId();
		if (i == R.id.iv_file_folder_back) {
			onBackPressed();

		} else if (i == R.id.btn_file_folder_ok) {
