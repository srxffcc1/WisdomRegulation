...
public class MediaPlayer {
  ...
  public void setSeekpotion(long seekpotion) {
	System.out.println("SRX:"+"alreadyset");
	this.seekpotion = seekpotion;
}

  public long getSeekpotion() {
	return seekpotion;
}
...
//        //Log.i("MiuiVideo: get message after player released, msg type: " + msg.what);
      ...
      switch (msg.what) {
        ...
        case MEDIA_ERROR:
          ...
          return;
        case MEDIA_INFO:
        	System.out.println("SRX:now"+getCurrentPosition());
        	System.out.println("SRX:need"+getSeekpotion());
        	if(getSeekpotion()!=0&&getCurrentPosition()<(getSeekpotion()-1000)){
        		
        		if(needseek){
        			seekTo(getSeekpotion());
        		}
        		
        	}
    		if(getCurrentPosition()>=(getSeekpotion())){
    			System.out.println("SRX:"+"quxiao");
    			needseek=false;
    		}
