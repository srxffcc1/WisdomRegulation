...
class ThreadPerTaskExecutorOrg implements Executor {
	public void execute(Runnable r) {
		new Thread(r).start();
	}
}

public class MuPDFActivityOrg extends Activity implements FilePicker.FilePickerSupport
{
	...
	public void createAlertWaiter() {
		...
		mAlertTask.executeOnExecutor(new ThreadPerTaskExecutorOrg());
	}
			...
			mOutlineButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					if (outline != null) {
						...
						Intent intent = new Intent(MuPDFActivityOrg.this, OutlineActivity.class);
	...
	public void proofWithResolution (int resolution)
	{
		...
		Intent intent = new Intent(this, MuPDFActivityOrg.class);
