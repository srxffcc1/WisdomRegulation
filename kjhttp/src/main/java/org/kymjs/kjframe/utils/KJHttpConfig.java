 ...
 */
public final class KJHttpConfig {
     ...
     * 错误处理广播
     */
    public static final String RECEIVER_ERROR = KJHttpConfig.class.getName()
            + "org.kymjs.android.frame.error";
    /**
     * 无网络警告广播
     */
    public static final String RECEIVER_NOT_NET_WARN = KJHttpConfig.class.getName()
