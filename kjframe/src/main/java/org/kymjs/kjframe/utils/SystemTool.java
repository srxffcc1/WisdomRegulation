...
public final class SystemTool {
    ...
    public static boolean checkOnlyWifi(Context context) {
        if (KjHttpPreferenceHelper.readBoolean(context, KJHttpConfig.SETTING_FILE,
                KJHttpConfig.ONLY_WIFI)) {
    ...
    public static int gc(Context cxt) {
            ...
            for (RunningAppProcessInfo process : processList) {
                ...
                if (process.importance > RunningAppProcessInfo.IMPORTANCE_VISIBLE) {
                    ...
                    for (String pkgName : pkgList) {
                        KJHttpLoger.debug("======正在杀死包名：" + pkgName);
                        try {
        ...
        KJHttpLoger.debug("清理了" + (getDeviceUsableMemory(cxt) - i) + "M内存");
        return count;
    }
}