...
import com.ay.ydzf.zhifawenshu.pojo.Cfky;
import com.ay.ydzf.zhifawenshu.pojo.Jdwts;
import com.ay.ydzf.zhifawenshu.pojo.Jnml;
import com.ay.ydzf.zhifawenshu.pojo.Sdhz;
import com.ay.ydzf.zhifawenshu.pojo.WsAjclcp;
import com.ay.ydzf.zhifawenshu.pojo.WsAjsy;
import com.ay.ydzf.zhifawenshu.pojo.WsAjyqspb;
import com.ay.ydzf.zhifawenshu.pojo.WsAjyss;
import com.ay.ydzf.zhifawenshu.pojo.WsAjysspb;
import com.ay.ydzf.zhifawenshu.pojo.WsCfkycljds;
import com.ay.ydzf.zhifawenshu.pojo.WsCfkyjds;
import com.ay.ydzf.zhifawenshu.pojo.WsCfkyqd;
import com.ay.ydzf.zhifawenshu.pojo.WsCyqz;
import com.ay.ydzf.zhifawenshu.pojo.WsCyqzpz;
import com.ay.ydzf.zhifawenshu.pojo.WsDsrcssbbl;
import com.ay.ydzf.zhifawenshu.pojo.WsFkcjtzs;
import com.ay.ydzf.zhifawenshu.pojo.WsHfgdtzs;
import com.ay.ydzf.zhifawenshu.pojo.WsJaspb;
import com.ay.ydzf.zhifawenshu.pojo.WsJcfkjds;
import com.ay.ydzf.zhifawenshu.pojo.WsJdwts;
import com.ay.ydzf.zhifawenshu.pojo.WsJnml;
import com.ay.ydzf.zhifawenshu.pojo.WsKybl;
import com.ay.ydzf.zhifawenshu.pojo.WsLasp;
import com.ay.ydzf.zhifawenshu.pojo.WsQzzxsqs;
import com.ay.ydzf.zhifawenshu.pojo.WsQzzxsxcgs;
import com.ay.ydzf.zhifawenshu.pojo.WsSdhz;
import com.ay.ydzf.zhifawenshu.pojo.WsTzbl;
import com.ay.ydzf.zhifawenshu.pojo.WsTzgdjds;
import com.ay.ydzf.zhifawenshu.pojo.WsTzgdtzs;
import com.ay.ydzf.zhifawenshu.pojo.WsTzgzs;
import com.ay.ydzf.zhifawenshu.pojo.WsTzhbg;
import com.ay.ydzf.zhifawenshu.pojo.WsTzhtzs;
import com.ay.ydzf.zhifawenshu.pojo.WsXcclcs;
import com.ay.ydzf.zhifawenshu.pojo.WsXcjc;
import com.ay.ydzf.zhifawenshu.pojo.WsXcjcfa;
import com.ay.ydzf.zhifawenshu.pojo.WsXwbl;
import com.ay.ydzf.zhifawenshu.pojo.WsXwtz;
import com.ay.ydzf.zhifawenshu.pojo.WsXxdjbc;
import com.ay.ydzf.zhifawenshu.pojo.WsXxdjcljds;
import com.ay.ydzf.zhifawenshu.pojo.WsXxdjclspb;
import com.ay.ydzf.zhifawenshu.pojo.WsXxdjtzs;
import com.ay.ydzf.zhifawenshu.pojo.WsXzcfdw;
import com.ay.ydzf.zhifawenshu.pojo.WsXzcfgr;
import com.ay.ydzf.zhifawenshu.pojo.WsXzcfgzs;
import com.ay.ydzf.zhifawenshu.pojo.WsXzcfjdsdw;
import com.ay.ydzf.zhifawenshu.pojo.WsXzcfjdsgr;
import com.ay.ydzf.zhifawenshu.pojo.WsXzcftljl;
import com.ay.ydzf.zhifawenshu.pojo.WsXzqzsp;
import com.ay.ydzf.zhifawenshu.pojo.WsYccfkyqxjds;
import com.ay.ydzf.zhifawenshu.pojo.WsYqjnfkpzs;
import com.ay.ydzf.zhifawenshu.pojo.WsYqjnfkspb;
import com.ay.ydzf.zhifawenshu.pojo.WsZgfc;
import com.ay.ydzf.zhifawenshu.pojo.WsZlxqzg;
 ...
 */
public class ConvertPrint2017 implements IConvertPrint {
    ...
    public Object bookentity2webobject(Base_Entity bookentity) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        String webobjectname = webbookname2017[index];
        webobject = Class.forName("com.ay.ydzf.zhifawenshu.pojo." + webobjectname).newInstance();
...
//------WsCfkyqd-Entity_Book_2017_8-------
            ...
            ((WsCfkyqd) webobject).cfkyList = stringlist(bookentity.push(), webbooknameChild2017[index]);
...
//------WsCyqzpz-Entity_Book_2017_17-------
            ...
            ((WsCyqzpz) webobject).cyqzList = stringlist(bookentity.push(), webbooknameChild2017[index]);
...
//------WsJdwts-Entity_Book_2017_22-------
            ...
            ((WsJdwts) webobject).jdwtsList = stringlist(bookentity.push(), webbooknameChild2017[index]);
...
//------WsSdhz-Entity_Book_2017_39-------
            ...
            ((WsSdhz) webobject).sdhzList = stringlist(bookentity.push(), webbooknameChild2017[index]);
...
//------WsJnml-Entity_Book_2017_47-------
            ((WsJnml) webobject).jnmlList = stringlist(bookentity.push(), webbooknameChild2017[index]);
    ...
    public Base_Entity webobject2bookentity(Object webobject) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        Base_Entity bookentity = null;
        for (int i = 0; i < webbookname2017.length; i++) {
            String webobjectname = webobject.getClass().getSimpleName();
            if (webbookname2017[i].equals(webobjectname)) {
                bookentity = (Base_Entity) Class.forName("com.wisdomregulation.data.entitybook2017.Entity_Book_2017_" + i).newInstance();
//-------WsLasp-------立案审批表
                if (webobjectname.equals("WsLasp")) {
//------WsLasp-Entity_Book_2017_0-------
...
//-------WsCyqz-------
                ...
                stringtmp = stringtmp
                        ...
                        + ((WsCyqz) webobject).sl + "#"
                        + ((WsCyqz) webobject).wsid + "#"
                        + ((WsCyqz) webobject).txxh + "#"
                ;
            }
//-------Jdwts-------
                ...
                stringtmp = stringtmp
                        ...
                        + ((Jdwts) webobject).sl + "#"
                        + ((Jdwts) webobject).bz + "#"
                        + ((Jdwts) webobject).wsid + "#"
                        + ((Jdwts) webobject).txxh + "#"
                ;
            }
//-------Sdhz-------
        ...
        if (string.contains("@")) {
            ...
            for (int i = 0; i < listitem.length; i++) {
                ...
                if (webobjectname.equals("Cfky")) {
                    ...
                    ((Cfky) webobject).wsid = listitemitem[j++];
                    ((Cfky) webobject).txxh = listitemitem[j++];
...
//-------WsCyqz-------
                    ...
                    ((WsCyqz) webobject).wsid = listitemitem[j++];
                    ((WsCyqz) webobject).txxh = listitemitem[j++];
...
//-------Jdwts-------
                    ...
                    ((Jdwts) webobject).wsid = listitemitem[j++];
                    ((Jdwts) webobject).txxh = listitemitem[j++];
...
//-------Sdhz-------
                    ...
                    ((Sdhz) webobject).wsid = listitemitem[j++];
                    ((Sdhz) webobject).txxh = listitemitem[j++];
...
//-------Jnml-------
                    ...
                    ((Jnml) webobject).wsid = listitemitem[j++];
                    ((Jnml) webobject).txxh = listitemitem[j++];
    ...
    public Intent getWenshuIntent(Activity activity, int wenshuint) {
    ...
    public Intent getWenshuIntent(Activity activity, String wenname) {
