...
//@ChineseName("行政处罚决定书（单位）")
public class WsXzcfjdsdw extends BasePojo {
	@ChineseName("行政执法id")
	...
	@ChineseName("法定代表人联系电话")
	public String fddbrlxdh;
	@ChineseName("违法事实及证据")
	public String wfsszj;
	@ChineseName("规定")
	public String gd;
	@ChineseName("依据")
	public String yj;
	...
	public void setWfsszj(String wfsszj) {
		this.wfsszj = wfsszj;
	}
